package main.java.explanation.version2;
...
class MenuContext {
	private final Map<String, List<Menu>> menus;	// 메뉴
	private final Map<String, List<Item>> menuItems;	// 상품메뉴
	private final List<Item> cart;	// 장바구니
